#!/usr/bin/python3
"""
    This python script that exports data in the CSV format
"""
import csv
import json
import requests
...
if __name__ == "__main__":
    """
        This request user info by employee ID
    """
    request_employee = requests.get(
        'https://jsonplaceholder.typicode.com/users/{}/'.format(argv[1]))
    """
       This convert json to dictionary
    """
    user = json.loads(request_employee.text)
    """
       This extract username
    """
    username = user.get("username")

    """
        This request user's TODO list
    """
    ...
    tasks = {}
    """
        This convert json to list of dictionaries
    """
    user_todos = json.loads(request_todos.text)
    """
        This loop through dictionary & get completed tasks
    """
